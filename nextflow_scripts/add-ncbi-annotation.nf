...
process novel_hits {
  ...
  echo "------------------------------------------------------"
  echo "::: INFO: add_ncbi_annotation pipeline ended correctly"
  echo "------------------------------------------------------"
  echo ""
  '''
}
...
process output_pipeline {
  ...
  mv gffcompare.tmap candidate_lncRNA_classes.txt final_annotated.gtf final_annotated.gff NCBI_transcripts.fa cds.fa prot.fa coding_transcripts.gtf Stats.txt transcriptome.swissprot novel-cds.fa novel-prot.fa ./output_files
