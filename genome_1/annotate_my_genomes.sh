...
echo ""
echo ""
echo "::: Replacing transcript_id field in merged.annotated_with_reference.gtf file to obtain the final GTF file"
echo ""
...
mv merged_with_reference_final.gtf summary.tab Stats.txt ./merged_annotation
rm summary.txt genes.tab genes2.tab
echo ""
