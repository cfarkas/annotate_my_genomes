...
rm gene_names2.tab filec transcript_gene_names.tab transcript_gene_names.txt gene_names.tab namelist
echo "Done"
echo ""
...
rm transcriptome_annotation_table.tsv transcriptome_annotation
CNIT.index CNIT
