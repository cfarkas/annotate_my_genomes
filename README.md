...
```
- The resulting GTF file is validated using Validate GTF tool from: Keibler, E. and M.R. Brent. 2003. "Eval: A software package for analysis of genome annotations." BMC Bioinformatics 4:50.
