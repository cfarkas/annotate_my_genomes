...
mv candidate_lncRNA_classes.txt final_annotated.gtf transcripts.fa cds.fa prot.fa cds.bed coding_transcripts.gtf logfile Stats.txt coding.hits ./output_files_UCSC/
