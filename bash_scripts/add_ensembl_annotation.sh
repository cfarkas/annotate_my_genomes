...
mkdir output_files
mv candidate_lncRNA_classes.txt final_annotated.gtf transcripts.fa transcriptsGO.tab cds.fa prot.fa Stats.txt coding_transcripts.gtf logfile augustus.gff3 ./output_files
...
echo ""
echo "GTF file final_annotated.gtf (standard GTF) containing Ensembl annotation and novel discoveries is located in ./output_files.".
echo ""
