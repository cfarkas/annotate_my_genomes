...
rm final_annotated.gtf
sed -i 's/AUGUSTUS/lncRNA/' merged.fixed.lncRNAs.gtf
sed -i 's/GeneMark.hmm3/lncRNA/' merged.fixed.lncRNAs.gtf
...
sed -i 's/AUGUSTUS/coding/' coding-genes.gtf
sed -i 's/GeneMark.hmm3/coding/' coding-genes.gtf
