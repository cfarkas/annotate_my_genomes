...
print("Number of annotated transcripts:", df2.shape[0])
print("Number of novel transcripts:", novel_transcripts.shape[0])
print("")
...
result = pd.merge(df3, dfA2, on='ref_id', how='inner')
result.sample(10)
print("Number of Joined Transcripts:", result.shape[0])
print("")
result.to_csv('Transcript_Annotation.csv', index=False)
novel_transcripts.to_csv('Novel_Transcripts.csv', index=False)
print(bcolors.OKGREEN + "Transcript_Annotation.csv and Novel_Transcripts.csv were succesfully produced"+ bcolors.ENDC)
print("")
